            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: <br /> Tues-Thurs: 6p-12a <br /> Fri: 6p-2a <br /> Sat: 4p-2a <br /> Sun: 6p-12a</li>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: <br /> Mon-Fri: 11:30a-2:30a <br /> Sat, Sun: 11a-2:30a</li>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <ul>
                        ...
                        <li>Hours: <br /> Mon, Tues: 5p-12a <br /> Wed-Fri: 4p-2a <br /> Sat: 6p-2a <br /> Sun: 2-8p</li>
